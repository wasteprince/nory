...
Получите их из официальных релизов Xray, sing-box и Mihomo, проверив опубликованные контрольные суммы. Сборки NORY 0.3.5 используют sing-box 1.13.18; его `libcronet.so` должен соответствовать версии ядра.
