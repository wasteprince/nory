...
![NORY 0.3.11 — тёмная тема](https://github.com/wasteprince/nory/releases/download/v0.3.11/NORY-0.3.11-dark.png)

<details>
<summary>Светлая тема</summary>

![NORY 0.3.11 — светлая тема](https://github.com/wasteprince/nory/releases/download/v0.3.11/NORY-0.3.11-light.png)
...
- Светлая тема и прежняя тёмная палитра с фиолетовыми акцентами; стеклянная панель, выбор темы в настройках.
- ICMP-пинг по умолчанию, корректные счётчики трафика Linux через API ядер, трей и логи.
- Подписанные обновления из GitHub: проверка при запуске и отдельный диалог новой версии.
- Быстрые счётчики и большие списки; автоматический прокси-пинг отключён, ручная проверка доступна.

## Установка

| Система | Пакет 0.3.11 | Как установить |
| --- | --- | --- |
| Arch Linux x86_64 | [pkg.tar.zst](https://github.com/wasteprince/nory/releases/download/v0.3.11/nory-0.3.11-1-x86_64.pkg.tar.zst) | `sudo pacman -U ./nory-0.3.11-1-x86_64.pkg.tar.zst` |
| Ubuntu 24.04+ / Debian 13+ amd64 | [deb](https://github.com/wasteprince/nory/releases/download/v0.3.11/nory_0.3.11_amd64.deb) | `sudo apt install ./nory_0.3.11_amd64.deb` |
| Windows 11 x64 | [Установщик](https://github.com/wasteprince/nory/releases/download/v0.3.11/NORY-0.3.11-windows-x64-setup.exe) | Запустить скачанный `.exe` |
...
NORY запрашивает подписки с `User-Agent: NORY/<версия>` (например, `NORY/0.3.11`), без подмены на Happ. Описание отдельного сервера читается из `meta.serverDescription` в его JSON-конфигурации.
...
[Сборка и структура проекта](desktop/README.md). В репозитории — код клиента, ресурсы и файлы упаковки. Готовые установщики находятся в [Releases](https://github.com/wasteprince/nory/releases). [Архив исходников 0.3.11](https://github.com/wasteprince/nory/releases/download/v0.3.11/nory-0.3.11-source.tar.gz).

[Изменения в 0.3.11](https://github.com/wasteprince/nory/releases/tag/v0.3.11) включены в пакеты для всех трёх систем.
