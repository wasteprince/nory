...
Все три канала — **arch, debian, windows** — получают стабильную версию 0.3.1.
...
| --- | --- | --- |
| Arch Linux, x86_64 | `nory-…-x86_64.pkg.tar.zst` | `sudo pacman -U ./nory-0.3.1-1-x86_64.pkg.tar.zst` |
| Ubuntu 24.04+ / Debian 13+, amd64 | `nory_…_amd64.deb` | `sudo apt install ./nory_0.3.1_amd64.deb` |
| Windows 11 x64 | `NORY-0.3.1-windows-x64-setup.exe` | Запустить установщик |
